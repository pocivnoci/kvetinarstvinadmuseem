-- ════════════════════════════════════════════════════════════════════
--  Načtení a uložení celého dokumentu adminu dvěma voláními.
--
--  Admin pracuje s jedním JSON dokumentem (objednávky, zákazníci, sklad,
--  tržby, faktury, nastavení). Tyhle dvě funkce ho skládají a rozkládají,
--  takže aplikace nemusí řešit pořadí zápisů do šesti tabulek.
--
